        ...
        <div class="container vertical-center">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <h4 class="color-white">Watch the livestream March 6 and 7</h4>
                  <form action="https://go.pardot.com/l/303201/2017-02-23/998i" method="post">
                        <div class="row">
                            <div class="coln-sm-12 col-md-6">
                                <div class="form-group">
                                <label class="sr-only">First Name</label><input class="form-control" type="text" name="firstname" required="required" placeholder="First Name" style="border-color:#fff;" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                <label class="sr-only">Last Name</label><input class="form-control" type="text" name="lastname" required="required" placeholder="Last Name" style="border-color:#fff;" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="sr-only">Email Address</label><input class="form-control" type="email" name="email" required="required" placeholder="Email Address" style="border-color:#fff;" />
                                </div>
                                <div class="form-group">
                                    <label class="sr-only">Company</label><input class="form-control" type="text" name="company" required="required" placeholder="Company" style="border-color:#fff;" />
                                </div>
                                <div class="form-group">
                                    <label class="sr-only">Job Title</label><input class="form-control" type="text" name="jobtitle" required="required" placeholder="Job Title" style="border-color:#fff;" />
                                </div>
                                <div style="position:absolute; left:-9999px; top: -9999px;">
                                <label for="pardot_extra_field">Comments</label>
                                <input type="text" id="pardot_extra_field" name="pardot_extra_field">
                                </div>
                                <button type="submit" class="btn btn-default" value="submit" required="required" />Watch now</button>
                            </div>
                        </div>
                    </form>          
                </div>
...
<section class="section-padding background-primary-light">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="text-center section-title" style="margin-bottom:0;">Featured Speakers</i></h2>    
            </div>
        </div>
    </div>
    <div id="speakers" class="slider-arrows">
        <div class="container padding-60">
            <div id="speakers-slides" class="row speaker-tiles">
                <?php echo do_shortcode('[featured-speaker-tiles]');?>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-center"><a href="http://www.marriott.com/hotels/travel/wasgn-gaylord-national-resort-and-convention-center/" target="_blank" class="btn btn-default-outline btn-lg">Visit the Venue</a></p>
                    </div>          
                </div>
            </div>
        </div>
